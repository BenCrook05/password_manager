...
# for i in range(10):
#     seed = 'bencrook'
#     seed2 = 'crookbenj@gmail.com'
#     client_permanent_key = Hash.create_client_permanent_key(seed, seed2)
...
#     e, d, n = AsyncRSA.generate_keys(random=False, seed=data_integer_string)
#     print(f"""
#         password: {seed}
#         email: {seed2}
#         key: {e,d,n}
...
#     seed2 = ''.join(random.choices(string.ascii_letters + string.digits, k=15))
#     client_permanent_key = Hash.create_client_permanent_key(seed, seed2)
#     client_permanent_key = str(client_permanent_key)
#     current_date = str(datetime.now().strftime("/%m/%Y"))
#     permanent_key_integer_list = list(map(ord,(client_permanent_key)))
