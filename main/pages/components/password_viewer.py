            ...
            controls=[
                ...
                Row(
                    controls=[
                        ...
                        Text(self.__url,size=20,weight=FontWeight.BOLD),
                    ],
                    spacing=20,
                    vertical_alignment=CrossAxisAlignment.CENTER,
                    alignment = MainAxisAlignment.SPACE_BETWEEN
                ...
                Row(
                    controls=[
                        ...
                        Text(self.__current_username,size=20,weight=FontWeight.BOLD),
                    ],
                    spacing=20,
                    vertical_alignment=CrossAxisAlignment.CENTER,
                    alignment = MainAxisAlignment.SPACE_BETWEEN
                ...
                Row(
                    controls=[
                        ...
                        Text(self.__current_additional_info,size=14,weight=FontWeight.BOLD),
                    ],
                    spacing=20,
                    vertical_alignment=CrossAxisAlignment.CENTER,
                    alignment = MainAxisAlignment.SPACE_BETWEEN,
