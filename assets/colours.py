...
class Colours:
    ...
    def set_dark_mode(self):
        ...
        curs = db.cursor()
        curs.execute("CREATE TABLE IF NOT EXISTS Colours(ColoursID VARCHAR(8) primary key, ColourHex VARCHAR(32))")
        curs.execute("INSERT OR REPLACE INTO Colours (ColoursID, ColourHex) VALUES ('BACKGROUND_COLOUR', '#121212')")
        curs.execute("INSERT OR REPLACE INTO Colours (ColoursID, ColourHex) VALUES ('THEME_COLOUR', '#281091')")
        curs.execute("INSERT OR REPLACE INTO Colours (ColoursID, ColourHex) VALUES ('TEXT_COLOUR', '#8FAACE')")
        curs.execute("INSERT OR REPLACE INTO Colours (ColoursID, ColourHex) VALUES ('BACKGROUND_COLOUR_2', '#23262a')")
